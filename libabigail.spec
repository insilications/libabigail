...
Source0  : https://mirrors.kernel.org/sourceware/libabigail/libabigail-1.8.tar.gz
...
%prep
%setup -q -n libabigail-1.8
cd %{_builddir}/libabigail-1.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606868637
...
cp %{_builddir}/libabigail-1.8/COPYING %{buildroot}/usr/share/package-licenses/libabigail/f81facfd488e95a394b99c4b8ac4add46b19999d
cp %{_builddir}/libabigail-1.8/COPYING-GPLV3 %{buildroot}/usr/share/package-licenses/libabigail/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/libabigail-1.8/COPYING-LGPLV2 %{buildroot}/usr/share/package-licenses/libabigail/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/libabigail-1.8/COPYING-LGPLV3 %{buildroot}/usr/share/package-licenses/libabigail/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
